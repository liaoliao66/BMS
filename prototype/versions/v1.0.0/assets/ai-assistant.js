...
(function () {
  ...
  const FEATURES = [
    ...
    { id: "F3", name: "工作汇报草稿", chip: "生成本周工作汇报草稿", pages: ["reports"] },
  ...
  const MOCK = {
    ...
    F2: "**经营总览 AI 解读（2026-Q3 · 截止 08-26）**\n\n1. **需关注目标 5 项**，其中风险 2 项，较上周 +1，主要来自设备部桥吊专项。\n2. **本周到期节点 4 个**，临期 2、逾期 1，建议优先跟进装卸队效率复核节点。\n3. **待汇报 31 人**，填报率约 71%，未填集中在夜班班组。\n4. **滞后任务 7 项**（任务 5 / 目标 2），督办中 9 项。\n5. **合同回款率 58%**，剩余收款 1535 万，商务部 2 笔大额待收。\n\n⚠️ 辅助参考，不构成考核依据。",
    F3: "**2026-W34 工作汇报草稿（装卸队视角）**\n\n## 一、目标完成情况\n- 8 月装卸效率提升：量化达成 82/100，健康「需关注」，较上周无变化。\n- 堆场周转优化：健康「正常」，节点 3/4 按期。\n\n## 二、计划进展\n- 8 月装卸效率提升计划：节点 2/4 按期，下一节点 08-25 效率复核。\n- 夜班协同保障计划：任务概况 进行中 4 / 已完成 2 / 滞后 1。\n\n## 三、任务执行\n- 本周期更新 14/18 条；滞后 3 条（桥吊夜班流程复盘等）。\n- 填报率 71%，未填 8 人。\n\n## 四、需协调事项\n- 桥吊点检专项需设备部配合窗口期。\n\n---\n请核对后复制至汇报系统或文档。",
    ...
    F13: "**催填提醒语（可复制发送）**\n\n【经营目标管理】您好，2026-W34 周报尚未提交。请在本周末前进入「任务清单」填写本周期进展说明。如有阻塞请在填报中注明。感谢配合！\n\n—— 装卸队 · 目标管理系统",
  ...
  function injectPageButtons() {
    ...
    const hooks = {
      ...
      reports: [
        { label: "生成汇报草稿", fid: "F3", q: "生成本周工作汇报草稿" },
