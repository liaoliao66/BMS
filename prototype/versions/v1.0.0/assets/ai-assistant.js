...
(function () {
  ...
  const FEATURES = [
    ...
    { id: "F6", name: "风险与督办建议", chip: "本周最该催办谁？", pages: ["dashboard", "supervise", "reports"] },
    ...
    { id: "F13", name: "催填话术生成", chip: "生成周报催填提醒语", pages: ["reports"] },
  ...
  function injectPageButtons() {
    ...
    const hooks = {
      ...
      reports: [
        ...
        { label: "AI 生成提醒语", fid: "F13", q: "生成周报催填提醒语" },
      ],
