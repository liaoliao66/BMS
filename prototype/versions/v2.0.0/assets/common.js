/* 经营管理系统 v2.0.0 · PC 公共壳（第二期：经营一体化） */
(function () {
  const NAV = [
    {
      group: "经营台账",
      items: [
        { id: "overview", name: "经营总览", href: "经营台账_总览_page.html", icon: "fa-chart-pie" },
        { id: "depts", name: "任务台账（V1）", href: "../../v1.0.0/pages/部门工作台_部门工作台_page.html", icon: "fa-sitemap" },
        { id: "reports", name: "工作周报（V1）", href: "../../v1.0.0/pages/经营台账_工作汇报_page.html", icon: "fa-file-lines" },
      ],
    },
    {
      group: "生产作业",
      items: [
        { id: "workload", name: "作业量管理", href: "生产作业_作业量管理_page.html", icon: "fa-ship" },
      ],
    },
    {
      group: "经营计划",
      items: [
        { id: "biz-goals", name: "经营目标", href: "经营计划_经营目标_page.html", icon: "fa-bullseye" },
        { id: "goals", name: "工作目标（V1）", href: "../../v1.0.0/pages/目标管理_目标列表_page.html", icon: "fa-flag" },
        { id: "plans", name: "计划管理（V1）", href: "../../v1.0.0/pages/计划管理_计划列表_page.html", icon: "fa-calendar-check" },
      ],
    },
    {
      group: "客户 CRM",
      items: [
        { id: "crm-overview", name: "客户概览", href: "CRM_客户概览_page.html", icon: "fa-chart-line" },
        { id: "crm-customers", name: "客户列表", href: "CRM_客户列表_page.html", icon: "fa-building" },
    ...
    },
    {
      group: "合同结算",
      items: [
        { id: "contracts", name: "合同台账", href: "合同收款_合同管理_page.html", icon: "fa-file-contract" },
        { id: "invoices", name: "开票管理", href: "合同收款_开票记录_page.html", icon: "fa-file-invoice" },
        { id: "receipts", name: "收款管理", href: "合同收款_收款记录_page.html", icon: "fa-money-bill-wave" },
      ],
    },
    {
      group: "任务中心（V1）",
      items: [
        { id: "my-tasks", name: "任务清单", href: "../../v1.0.0/pages/任务中心_我的任务_page.html", icon: "fa-list-check" },
        { id: "supervise", name: "任务督办", href: "../../v1.0.0/pages/任务中心_任务督办_page.html", icon: "fa-clipboard-check" },
        { id: "projects", name: "专项管理", href: "../../v1.0.0/pages/专项管理_专项列表_page.html", icon: "fa-folder-open" },
      ],
    },
    {
      group: "基础配置（V1）",
      items: [
        { id: "cfg-scope", name: "使用范围", href: "../../v1.0.0/pages/基础配置_使用范围_page.html", icon: "fa-sliders" },
      ],
    },
  ];
    ...
    let html = `
      <aside class="w-64 shrink-0 bg-slate-800 text-slate-200 min-h-screen flex flex-col">
        <div class="px-5 py-5 border-b border-slate-700">
          ...
          <div class="text-xs text-slate-400 mt-1">v2.0.0 · 经营一体化</div>
        </div>
