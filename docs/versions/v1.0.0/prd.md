...
| 当前版本 | v1.0.0 |
| 版本更新时间 | 2026-08-27 |
| 版本迭代说明 | 产品正式名称调整为**经营管理系统**；**经营总览移除工作汇报快照条**；**专项管理**状态页签筛选、详情关联数据、删除级联；新建/编辑/督办/工作台任务支持**添加图片**；计划详情支持关键节点状态更新；工作汇报计划详情平铺下属任务 |
...
| 页面跳转 | 部门卡片 → 部门详情弹窗 → 工作台；风险/待汇报 → 任务详情/汇报提醒/任务督办；合同摘要 → 合同/收款管理；重点专项 → **专项管理详情** |
...
**正常流程：** 选年/季 → 扫 KPI → 下钻部门或专项 → 跳转工作台/汇报提醒/合同收款/专项管理跟进。  
...
> **说明：** 「需关注」仅用于**目标健康状态**（§7.9.1），不作为专项业务状态枚举值。
...
| Q18 | 经营总览 KPI 保留项 | 经营总览 | **已确认**：需关注目标、滞后任务、待汇报、本周到期节点、合同回款；**不含**工作汇报快照条 |
