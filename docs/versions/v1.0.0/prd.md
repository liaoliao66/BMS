...
| 当前版本 | v1.0.0 |
| 版本更新时间 | 2026-08-27 |
| 版本迭代说明 | 计划详情支持**关键节点状态更新**；工作汇报计划详情平铺下属任务 |
...
| 维度 | 内容 |
| --- | --- |
| 功能介绍 | 大尺寸弹窗创建/编辑任务；**计划任务必须关联计划**；补齐说明、起止、责任人、**配合人员（选填）**、优先级等；可选验收标准、工作类型、预期产出、风险、附件 |
...
| 非必填 | 验收标准、工作类型、**配合人员**、预期产出、风险提示、创建附件 | P0/P1 |
